...
# --- ESTILOS CSS REFORZADOS (PARA MODO CLARO Y OSCURO) ---
st.markdown("""
    <style>
    ...
    /* CARTA: FONDO BLANCO Y JUSTIFICADO */
    .carta-box { 
    ...
    /* Estilo específico para el contenido del expander */
    .stDetails {
        background-color: #ffffff !important;
        border-radius: 10px;
    }
...
st.markdown('<p style="text-align: center; color: #000000 !important;">💌 Un mensaje especial</p>', unsafe_allow_html=True)
st.markdown('<h1 class="titulo-rosado">Para Ana María</h1>', unsafe_allow_html=True)

# Lógica de la imagen mejorada (Asegúrate de que el nombre sea correcto en GitHub)
img_path = "pareja.jpg" 
...
if img_b64:
    ...
    st.warning("📸 No se encontró la imagen. Verifica que el archivo esté en GitHub con el nombre correcto.")
